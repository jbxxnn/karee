...
export function About() {
  return (
    <div className="flex flex-col sm:flex-row gap-2 items-center h-auto md:h-[30rem] w-full p-3 md:p-0">
        <div className="flex flex-col gap-2 items-start w-[100%] md:w-[65%]">
            ...
            <div className="flex flex-col gap-2 w-[100%] md:w-[30%] items-center justify-end h-full">
                <Image 
                src="/home-1-3.jpg" 
                alt="About Kareè" 
                width={500}

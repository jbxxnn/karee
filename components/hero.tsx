    ...
    <div className="flex flex-col gap-2 items-center">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-ultrabold text-brand-black mb-6 font-pp-mori">
          ...
          <p className="text-sm md:text-base text-brand-black leading-relaxed font-pp-mori w-[100%] lg:w-[65%] lg:mx-auto">

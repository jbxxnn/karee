...
export function Header() {
  ...
  return (
    ...
    {/* Mobile Menu Overlay - Outside header to avoid positioning conflicts */}
    <div 
    ...
    {/* Mobile Menu - Outside header to avoid positioning conflicts */}
    <div 
      className={`lg:hidden fixed bottom-10 left-1/2 transform -translate-x-1/2 h-[60%] w-[90%] max-w-sm bg-white dark:bg-gray-900 shadow-2xl transition-transform duration-300 ease-in-out z-[70] rounded-lg ${
